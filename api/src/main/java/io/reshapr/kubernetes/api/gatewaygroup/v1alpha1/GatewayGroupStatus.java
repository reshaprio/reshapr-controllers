...
/**
 * This the {@code status} of a {@link GatewayGroup} custom resource.
 * @author laurent
 */
public class GatewayGroupStatus {
   ...
   @JsonPropertyDescription("Identifier of the corresponding GatewayGroup in the reShapr control plane")
